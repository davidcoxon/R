...
## description: Plot 1 of Coursera Exploratory Data Analysis, Project 2 
...
options(scipen=11)
## create plot
barplot(annualtotals,col.main=c("darkolivegreen4","darkolivegreen3","darkolivegreen2","darkolivegreen1"))
## set margins
par(mar=c(5,10,4,4))
## Add Labels
## axis labels
title(main="Total Annual PM2.5 emissions in USA 1999-2008",las=1,xlab="Year",col="darkolivegreen4")
